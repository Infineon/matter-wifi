...
#define CHIP_PLATFORM_CONFIG_INCLUDE <platform/Infineon/cat1/CHIPPlatformConfig.h>
#define SYSTEM_PROJECT_CONFIG_INCLUDE <CHIPProjectConfig.h>
#define SYSTEM_PLATFORM_CONFIG_INCLUDE <platform/Infineon/cat1/SystemPlatformConfig.h>
