...
#define CHIP_DEVICE_PLATFORM_CONFIG_INCLUDE <platform/Infineon/cat1/CHIPDevicePlatformConfig.h>
#define CHIP_USE_TRANSITIONAL_COMMISSIONABLE_DATA_PROVIDER 1
#define CHIP_DEVICE_LAYER_TARGET_PSOC6 1
#define CHIP_DEVICE_LAYER_TARGET Infineon/cat1
